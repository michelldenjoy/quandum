    ...
    <div className="w-full bg-white overflow-x-hidden font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="pt-6 border-t border-zinc-800 flex justify-between items-center">
                <span className="font-mono  text-brand-blue uppercase">
                  OASIS ID: 6130438025
                </span>
      ...
      <section className="py-24 bg-white px-6">
        <div className="max-w-6xl mx-auto border border-gray-100 p-12 relative overflow-hidden">
          {/* Marca de agua  */}
          <Box
            className="absolute -right-10 -bottom-10 text-gray-50"
            size={300}
          />
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                >
                  <span className="text-md uppercase font-bold tracking-widest text-black ">
                    {item}
                  </span>
                </div>
              ))}
