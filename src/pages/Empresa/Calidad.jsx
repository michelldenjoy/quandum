            ...
            <div className="grid md:grid-cols-12 gap-12">
              ...
              <div className="md:col-span-8 space-y-8 text-gray-600">
                <p className="text-xl md:text-2xl font-light leading-relaxed text-black italic">
                  "La Dirección de Quandum Aerospace establece la presente
                  Política como marco de referencia para el desarrollo de todas
                  sus actividades en los sectores{" "}
                  <span className="text-brand-blue font-semibold">
                    aeronáutico, defensa e industrial
                  </span>
                  ."
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-8  leading-relaxed">
                  <p>
                    Conscientes de la importancia de la seguridad y la
                    fiabilidad en sistemas de alta exigencia, la organización
                    mantiene un firme compromiso con la satisfacción del cliente
                    y el cumplimiento normativo.
                  </p>
                  <p>
                    Mantenemos un Sistema de Gestión conforme a las normas{" "}
                    <span className="font-bold text-black underline decoration-brand-blue underline-offset-4">
                      EN 9100:2018
                    </span>{" "}
                    e{" "}
                    <span className="font-bold text-black underline decoration-brand-blue underline-offset-4">
          ...
          <div className="grid lg:grid-cols-2 gap-px bg-gray-200 border border-gray-200">
            ...
            <div className="bg-white p-12 lg:p-16">
              <div className="flex items-center gap-4 mb-10">
                ...
                <h3 className="text-2xl text-slate-800 font-bold uppercase tracking-tight">
              ...
              <div className="grid sm:grid-cols-1 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-3 p-4 border border-gray-100 group hover:border-black transition-all"
                  >
        ...
        <div className="relative group scale-110 md:scale-125">
          ...
          >
            ...
            <div className="relative text-center z-10">
              ...
              <p className="text-xs text-cyan-400/80 tracking-[0.3em] font-semibold">
                CERTIFIED SYSTEM
              </p>
            </div>
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-cyan-500 to-sky-500 text-white text-[10px] font-bold px-6 py-2 rounded-full shadow-lg">
              ISO 9001:2015
            </div>
            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-sky-600 to-cyan-600 text-white text-[10px] font-bold px-6 py-2 rounded-full text-center shadow-lg">
              QUANDUM AEROSPACE
            </div>
          </motion.div>
        </div>
