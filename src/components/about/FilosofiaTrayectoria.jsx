...
export default function FilosofiaTrayectoria() {
  return (
    <section className="w-full relative bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-32 lg:py-40 space-y-32">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-light text-white leading-tight tracking-tight">
              Nuestra <span className="bg-gradient-to-r from-blue-400 via-blue-300 to-cyan-400 bg-clip-text text-transparent">Filosofía</span>
            </h2>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-light text-white leading-tight tracking-tight">
              Nuestra <span className="bg-gradient-to-r from-blue-400 via-blue-300 to-cyan-400 bg-clip-text text-transparent">Trayectoria</span>
            </h2>
