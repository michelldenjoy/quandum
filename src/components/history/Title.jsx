...
export default function Title() {
  ...
  const words = t("titleHitos.words", { returnObjects: true });

  return (
    <div className="relative mb-32 bg-gradient-to-t  from-black via-black/40 to-black/60 md:bg-gradient-to- md:from-black/95 md:to-black/30">
