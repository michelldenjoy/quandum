        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/proyectos/destacados" className="hover:text-white transition-colors">Proyectos</Link></li>
              <li><Link to="/sobre-quandum/certificaciones" className="hover:text-white transition-colors">Certificaciones</Link></li>
              <li><Link to="/empresa/about" className="hover:text-white transition-colors">Sobre Nosotros</Link></li>              
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
            <li>
                <Link to="/proyectos/destacados/1" className="hover:text-white transition-colors">
                  Sistema IR y Visión Mejorada
                </Link>
              </li> 
              <li>
                <Link to="/proyectos/destacados/3" className="hover:text-white transition-colors">
                  Sistema de Codificación
                </Link>
              </li> 
              <li>
                <Link to="/proyectos/destacados/6" className="hover:text-white transition-colors">
                  Sistema de Iluminación
                </Link>
              </li>                
              <li>
                <Link to="/proyectos/destacados/7" className="hover:text-white transition-colors">
                  Sistema de Inspeccion Inteligente
                </Link>
              </li>   
